...
export const useGooglePlacesAutocomplete = (inputRef: React.RefObject<HTMLInputElement | null>) => {
  ...
  useEffect(() => {
    ...
    script.onerror = () => { if (process.env.NODE_ENV === 'development') console.error('Failed to load Google Maps script'); };
