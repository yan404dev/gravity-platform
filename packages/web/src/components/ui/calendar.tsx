...
function CustomCaption(props: CaptionProps) {
    ...
    return (
        <div className="mb-4 flex items-center justify-between border border-black px-2 py-1">
            <span className="text-base font-normal md:text-lg lg:text-xl">
                {format(displayMonth, 'MMMM yyyy')}
            </span>
            <div className="flex items-center space-x-1">
                <Button
                    variant="ghost"
                    className="h-7 w-7 rounded-none bg-transparent p-0 opacity-50 hover:opacity-100"
